...
<head>
    ...
    <style>
        /* =========================================
           ...
           ========================================= */
        :root {
            /* Light Theme (โทนเหลือง-แดง) */
            --bg-color: #fffbeb; /* พื้นหลังสีเหลืองอ่อน */
            --text-color: #450a0a; /* ตัวอักษรสีแดงเข้ม/น้ำตาล */
            --primary-color: #dc2626; /* แดง */
            --accent-color: #d97706; /* เหลืองอมส้ม (Amber) */
            
            /* Glassmorphism Effects */
            --glass-bg: rgba(255, 255, 255, 0.45);
            --glass-border: rgba(255, 255, 255, 0.7);
            --glass-shadow: 0 8px 32px 0 rgba(220, 38, 38, 0.1); /* เงาอมแดง */
            
            /* Background Blobs */
            --blob-1: #fef08a; /* เหลือง */
            --blob-2: #fca5a5; /* แดงอ่อน */
            --blob-3: #fde047; /* เหลืองสว่าง */
        }

        [data-theme="dark"] {
            /* Dark Theme (โทนแดงเข้ม-เหลือง) */
            --bg-color: #2c0b0e; /* พื้นหลังแดงเลือดหมูเข้มมาก */
            --text-color: #fef3c7; /* ตัวอักษรสีครีม/เหลืองอ่อน */
            --primary-color: #ef4444; /* แดงสว่าง */
            --accent-color: #fbbf24; /* เหลืองทอง */
            
            --glass-bg: rgba(30, 5, 5, 0.6);
            --glass-border: rgba(255, 255, 255, 0.1);
            --glass-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.4);
            
            --blob-1: #7f1d1d; /* แดงเข้ม */
            --blob-2: #b45309; /* ส้มอิฐ/น้ำตาลทอง */
            --blob-3: #991b1b; /* แดงมืด */
        }
        ...
        * {
        ...
        .glass-btn.primary:hover { background: var(--accent-color); color: #fff; }
        ...
        .close-btn:hover { opacity: 1; color: var(--primary-color); }
...
<body>
    ...
    <script>
        ...
        // ชุดคำถามประเมินผล 15 ข้อ พร้อมค่าน้ำหนัก
        const quizQuestions = [
        ...
        function openModal(classId) {
            ...
            modalBody.innerHTML = `
                <span class="tag" style="background: var(--accent-color); color:#fff;">${cls.level}</span>
            ...
            classData.forEach((c, index) => {
                tableHTML += `
                    <tr>
                        ...
                        <td>${c.name}</td>
                        <td>
                            <button class="glass-btn" style="padding: 5px 12px; color: var(--primary-color); font-size:0.85rem;" onclick="deleteClass(${index})">🗑️ ลบข้อมูล</button>
                        </td>
                    </tr>`;
            });
